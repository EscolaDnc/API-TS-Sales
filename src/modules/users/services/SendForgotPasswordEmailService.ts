...
class SendForgotPasswordEmailService {
  public async execute({ email }: IRequest): Promise<void> {
    ...
    sendEmail({
      ...
      body: `
        <div style="font-family: Arial, sans-serif; padding: 20px; color: #333; text-align: center; border: 2px solid #041d40; border-radius: 10px; background-color: #F0F8FF; margin: auto; width: 60%;">
          ...
          <p>
            <strong style="border: 2px dashed #041d40; background-color: #E6F7FF; padding: 10px; border-radius: 5px; font-size: 16px; color: #4A90E2;">${token?.token}</strong>
          </p>
